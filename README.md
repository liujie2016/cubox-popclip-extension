...
| 版本 | 发布日期 | 主要更新 |
|------|----------|----------|
| **v5.4** | 2025-01-29 | 🔧 添加网络权限配置，修复 XMLHttpRequest 权限错误 |
| **v5.3** | 2025-01-28 | 🚀 改为异步请求，提升用户体验和稳定性 |
| **v5.2** | 2025-01-27 | 🌐 支持新 API 格式 `/c/api/save/TOKEN` |
| **v5.1** | 2025-01-26 | 🔗 添加 cubox.pro 域名支持 |
| **v5.0** | 2025-01-25 | 📝 修复 PopClip 标准格式兼容性 |
| **v4.x** | 2024-12-15 | 🐛 多个 bug 修复和功能优化 |
| **v1.0** | 2024-11-20 | 🎉 首次发布 |
